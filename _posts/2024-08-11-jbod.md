...
description: Bringing a $120 SGI SE3016 disk shelf back from the dead with a custom ESP32 "IPMI" controller, a modern SFF PSU, Noctua fans, and a SAS2 expander — full BOM and build notes.
image:
  path: /assets/img/cards/jbod.png
  alt: "Frankenstein JBOD DAS"
---
...
![This was the mk1 PCB, I had intended to use optoisolators but decided aginst it](/assets/posts/jbod-1.jpg)
This was the mk1 PCB, I had intended to use optoisolators but decided aginst it.

![This was before any changes were made, other than the 120mm fan mod](/assets/posts/jbod-2.jpg)
This was before any changes were made, other than the 120mm fan mod.

![Top down view of the front header panel, the RJ45 jack wasn't reused, but the button and leds were](/assets/posts/jbod-4.jpg)
Top down view of the front header panel, the RJ45 jack wasn't reused, but the button and leds were

![First time I had my hands on a SFF PSU, was blown away at how small it is](/assets/posts/jbod-5.jpg)
First time I had my hands on a SFF PSU, was blown away at how small it is

![Comparison of the old and new PSUs](/assets/posts/jbod-6.jpg)
Comparison of the old and new PSUs

![This slot on the top left was just a blank, I'm thinking Rackables intended to stick an LCD in there. I printed an adapter bracket to hold the .91" OLED in there](/assets/posts/jbod-7.jpg)
...
![Pic on the new PSU on its resin printed bracket (sits in the old standoffs to help secure it)](/assets/posts/jbod-8.jpg)
Pic on the new PSU on its resin printed bracket (sits in the old standoffs to help secure it)

![Another pic of the OLED bracket without the lid](/assets/posts/jbod-9.jpg)
Another pic of the OLED bracket without the lid

![The new sas expander, trying to pick the best spot in the chassis](/assets/posts/jbod-10.jpg)
The new sas expander, trying to pick the best spot in the chassis

![The mk2 PCB, with the tiny ssop PCA chip. Yubikey for size comparison](/assets/posts/jbod-11.jpg)
The mk2 PCB, with the tiny ssop PCA chip. Yubikey for size comparison

![Easier than it looked, just don't try it without flux](/assets/posts/jbod-12.jpg)
Easier than it looked, just don't try it without flux

![It verks!](/assets/posts/jbod-13.jpg)
It verks!

![Front view (after the old stuff was ripped out)](/assets/posts/jbod-14.jpg)
Front view (after the old stuff was ripped out)

![Old SAS expander/mobo](/assets/posts/jbod-15.jpg)
Old SAS expander/mobo

![Top down of old parts and one of the drive trays](/assets/posts/jbod-16.jpg)
Top down of old parts and one of the drive trays

![Top down of the new parts, PSU and SAS expander mounted on their 3d printed carriers, and the SAS passthrough has been cut into the back](/assets/posts/jbod-17.jpg)
...
![Top down of the assembled controller](/assets/posts/jbod-18.jpg)
Top down of the assembled controller

### 3D Prints

STLs for the printed parts are coming — reach out if you want them before I get them posted.

### Full BOM

Not including parts I already had on hand like resistors, standard header pins, the OLED screen, fdm filament, printer resin, tools, wire, and anything else not mentioned below.
