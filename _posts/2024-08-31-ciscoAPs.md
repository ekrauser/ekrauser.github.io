...
description: Ditching UniFi for Cisco 2702i APs and a 9800-CL WLC on Proxmox — DHCP option 43 gotchas, trunk config on the 3850 and Brocade, and bootstrapping the controller.
image:
  path: /assets/img/cards/ciscoAPs.png
  alt: "Going Full Circle with Cisco"
---
...
I'll be rolling out the Cisco 9800-CL cloud WLC for this. Maybe it's just my old edu creds, but i was able to download one of the popular recent versions without issue. Licensing is tied to each AP, and anything subscription based is obviously off the table, but we should be alright on the honor system.
